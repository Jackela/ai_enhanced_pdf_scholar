...
class TestPerformance:
    ...
    def test_bulk_insert_performance(self, db_connection):
        ...
        print(f"Inserted {num_records} records in {duration:.3f}s ({num_records/duration:.0f} records/sec)")
    ...
    def test_connection_pool_efficiency(self, db_connection):
        ...
        stats_before = db_connection.get_pool_stats()
        ...
        reuse_ratio = stats_after['reused'] / total_operations if total_operations > 0 else 0
