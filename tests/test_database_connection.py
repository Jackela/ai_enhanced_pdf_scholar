...
class TestDatabaseConnection:
    ...
    def test_fetch_all_method(self):
        ...
        self.db.execute_many("INSERT INTO test (value) VALUES (?)", [(i,) for i in range(5)])
    ...
    def test_thread_safety(self):
        ...
        def worker_thread(thread_id):
            ...
            try:
                ...
                for i in range(5):
                    self.db.execute("INSERT INTO test (thread_id) VALUES (?)", (thread_id,))
    ...
    def test_row_factory_dict_access(self):
        ...
        # Create and populate test table
        self.db.execute("CREATE TABLE test (id INTEGER PRIMARY KEY, name TEXT, value INTEGER)")
