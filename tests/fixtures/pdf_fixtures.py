...
class PDFFixtureGenerator:
    ...
    def create_multi_page_pdf(self, filename: str = "multi_page.pdf") -> Path:
        ...
        # Page 1
        page1 = doc.new_page()
        page1.insert_text((72, 72), "This is page 1.\nIt contains the first part of the document.", fontsize=12)
        
        # Page 2
        page2 = doc.new_page()
        page2.insert_text((72, 72), "This is page 2.\nIt contains the second part of the document.", fontsize=12)
        
        # Page 3
        page3 = doc.new_page()
        page3.insert_text((72, 72), "This is page 3.\nThis is the final page of the test document.", fontsize=12)
    ...
    def create_identical_content_pdfs(self, base_filename: str = "identical_content") -> List[Path]:
        """
    ...
    def create_different_content_pdfs(self, base_filename: str = "different_content") -> List[Path]:
        """
    ...
    def create_special_characters_pdf(self, filename: str = "special_chars.pdf") -> Path:
        """
    ...
    def create_large_pdf(self, filename: str = "large_document.pdf", pages: int = 50) -> Path:
        """
    ...
    def create_binary_identical_pdfs(self, filename: str = "binary_identical.pdf") -> List[Path]:
        """
