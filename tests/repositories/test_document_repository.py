...
class TestDocumentRepository:
    ...
    def test_find_by_content_hash_success(self):
        ...
        document = self._create_test_document(
            ...
            content_hash="unique_content_hash_123"
        )
        created_doc = self.repository.create(document)
    ...
    def test_find_by_file_path_success(self):
        ...
        document = self._create_test_document(
            title="Path Test",
            file_path="/unique/file/path.pdf"
        )
        created_doc = self.repository.create(document)
    ...
    def test_search_by_title_success(self):
        ...
        docs = [
            self._create_test_document(title="Python Programming Guide", file_path="/path1.pdf", file_hash="hash1"),
            self._create_test_document(title="Java Programming Manual", file_path="/path2.pdf", file_hash="hash2"),
            self._create_test_document(title="Data Science Handbook", file_path="/path3.pdf", file_hash="hash3")
        ]
    ...
    def test_search_general(self):
        ...
        docs = [
            self._create_test_document(title="Machine Learning", file_path="/ml.pdf", file_hash="hash1"),
            self._create_test_document(title="Deep Learning", file_path="/dl.pdf", file_hash="hash2"),
            self._create_test_document(title="Natural Language Processing", file_path="/nlp.pdf", file_hash="hash3")
        ]
    ...
    def test_find_by_size_range(self):
        ...
        docs = [
            self._create_test_document(title="Small Doc", file_path="/small.pdf", file_hash="hash1", file_size=500),
            self._create_test_document(title="Medium Doc", file_path="/medium.pdf", file_hash="hash2", file_size=1500),
            self._create_test_document(title="Large Doc", file_path="/large.pdf", file_hash="hash3", file_size=3000)
        ]
    ...
    def test_find_by_date_range(self):
        ...
        docs = [
            self._create_test_document(title="Old Doc", file_path="/old.pdf", file_hash="hash1"),
            self._create_test_document(title="Recent Doc", file_path="/recent.pdf", file_hash="hash2"),
            self._create_test_document(title="New Doc", file_path="/new.pdf", file_hash="hash3")
        ]
    ...
    def test_get_statistics_with_documents(self):
        ...
        docs = [
            self._create_test_document(title="Doc 1", file_path="/doc1.pdf", file_hash="hash1", file_size=1000, page_count=10),
            self._create_test_document(title="Doc 2", file_path="/doc2.pdf", file_hash="hash2", file_size=2000, page_count=20),
            self._create_test_document(title="Doc 3", file_path="/doc3.pdf", file_hash="hash3", file_size=3000, page_count=30)
        ]
    ...
    def test_find_duplicates_by_size_and_name(self):
        ...
        docs = [
            self._create_test_document(title="Python Guide", file_path="/guide1.pdf", file_hash="hash1", file_size=1500),
            self._create_test_document(title="Python Guide", file_path="/guide2.pdf", file_hash="hash2", file_size=1500),
            self._create_test_document(title="Java Manual", file_path="/manual.pdf", file_hash="hash3", file_size=2000)
        ]
    ...
    def test_advanced_search_with_date_filters(self):
        ...
        # Create documents with different dates
        old_doc = self._create_test_document(title="Old Document", file_path="/old.pdf", file_hash="hash1")
        new_doc = self._create_test_document(title="New Document", file_path="/new.pdf", file_hash="hash2")
