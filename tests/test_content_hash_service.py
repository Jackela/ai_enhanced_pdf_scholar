...
class TestContentHashService:
    ...
    def test_deduplication_scenario(self):
        ...
        assert len(set(file_hashes)) == len(
            file_hashes
        ), "File hashes should be different for different files"
    ...
    def test_large_file_processing(self):
        ...
        with patch("builtins.open") as mock_open:
            ...
            mock_file.read.side_effect = [
                b"a" * ContentHashService.CHUNK_SIZE,
                b"b" * 1000,
                b"",
            ]
            ...
            with patch("pathlib.Path.exists", return_value=True):
                with patch("pathlib.Path.is_file", return_value=True):
                    hash_result = ContentHashService.calculate_file_hash(
                        "/fake/large/file.pdf"
                    )
