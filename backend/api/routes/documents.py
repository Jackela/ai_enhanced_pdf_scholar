...
from backend.api.dependencies import (
    get_library_controller, get_upload_directory, validate_document_access, get_api_config
)
...
async def get_documents(
    ...
    sort_by: str = Query("created_at", regex="^(created_at|updated_at|last_accessed|title|file_size)$"),
    sort_order: str = Query("desc", regex="^(asc|desc)$"),
    page: int = Query(1, ge=1, description="Page number"),
    per_page: int = Query(50, ge=1, le=200, description="Items per page"),
    show_missing: bool = Query(False, description="Include documents with missing files"),
        ...
        try:
            ...
            if documents:
                ...
                return DocumentImportResponse(
                    document=DocumentResponse(**doc_dict)
                )
