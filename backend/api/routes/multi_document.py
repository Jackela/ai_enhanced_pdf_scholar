...
from backend.api.dependencies import get_db, get_multi_document_rag_service
...
def convert_query_to_response(query_model) -> MultiDocumentQueryResponse:
    ...
    from backend.api.models.multi_document_models import DocumentSourceResponse, CrossReferenceResponse
