...
class SettingsManager:
    ...
    def _initialize_settings_table(self):
        ...
        try:
            ...
            # Create index
            self.db.execute("CREATE INDEX IF NOT EXISTS idx_settings_key ON system_settings(key)")
    ...
    try:
        ...
        if request.gemini_api_key is not None:
            ...
            if not request.gemini_api_key.startswith("●"):
                settings_manager.set_setting("gemini_api_key", request.gemini_api_key.strip())
    ...
    try:
        ...
        try:
            ...
            if model_list:
                ...
                return ApiKeyTestResponse(valid=False, error="No models available with this API key")
