  ...
  return (
    <div className='max-w-4xl mx-auto p-6 space-y-8'>
      <div className='border-b border-gray-200 dark:border-gray-700 pb-4'>
        ...
        <p className='text-gray-600 dark:text-gray-400 mt-2'>配置API密钥和系统参数</p>
      </div>

      {/* API Configuration Section */}
      <div className='bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6'>
        <h2 className='text-xl font-semibold text-gray-900 dark:text-white mb-4'>AI服务配置</h2>
          ...
          <div className='flex items-center justify-between'>
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${
                settings.rag_enabled ? 'bg-blue-600' : 'bg-gray-200 dark:bg-gray-700'
              }`}
            >
              <span
      ...
      <div className='bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6'>
        <h2 className='text-xl font-semibold text-gray-900 dark:text-white mb-4'>系统状态</h2>
