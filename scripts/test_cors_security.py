    ...
    for i, test_case in enumerate(test_cases, 1):
        ...
        try:
            ...
            if test_case["should_pass"]:
                ...
                print(
                    f"   Origins: {len(middleware_config['allow_origins'])} configured"
                )
                ...
                if config.environment == Environment.DEVELOPMENT:
                    ...
                    print(
                        f"   Origin Details: [Hidden for security in {config.environment.value}]"
                    )
            ...
            if not test_case["should_pass"]:
                print(
                    "✅ SUCCESS: Security validation correctly blocked vulnerable config"
                )
                print(f"   Error: {e}")
            else:
