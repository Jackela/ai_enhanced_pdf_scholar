...
class MultiDocumentCollectionRepository(IMultiDocumentCollectionRepository):
    ...
    def get_by_id(self, entity_id: int) -> Optional[MultiDocumentCollectionModel]:
    ...
    def find_by_name(self, name: str) -> Optional[MultiDocumentCollectionModel]:
...
class MultiDocumentIndexRepository(IMultiDocumentIndexRepository):
    ...
    def get_by_id(self, entity_id: int) -> Optional[MultiDocumentIndexModel]:
        """Get index by ID."""
        try:
            with self.db.get_connection() as conn:
                cursor = conn.cursor()
    ...
    def get_by_collection_id(self, collection_id: int) -> Optional[MultiDocumentIndexModel]:
    ...
    def find_by_hash(self, index_hash: str) -> Optional[MultiDocumentIndexModel]:
        """Find index by hash."""
        try:
            with self.db.get_connection() as conn:
                cursor = conn.cursor()
...
class CrossDocumentQueryRepository(ICrossDocumentQueryRepository):
    ...
    def get_by_id(self, entity_id: int) -> Optional[CrossDocumentQueryModel]:
        """Get query by ID."""
        try:
            with self.db.get_connection() as conn:
                cursor = conn.cursor()
