...
class PerformanceOptimizationMigration(BaseMigration):
    ...
    def down(self) -> None:
        ...
        performance_indexes = [
            ...
            "idx_documents_content_hash_perf",
            "idx_documents_created_desc_perf",
            "idx_documents_updated_desc_perf",
            "idx_documents_accessed_desc_perf",
            "idx_documents_title_search",
            "idx_documents_file_size",
            "idx_documents_page_count",
            # Composite document indexes
            "idx_documents_created_title_comp",
            "idx_documents_access_size_comp",
            "idx_documents_hash_created_comp",
            "idx_documents_content_pages_comp",
            # Vector indexes
            "idx_vector_indexes_document_perf",
            "idx_vector_indexes_hash_unique",
            "idx_vector_indexes_created_desc",
            "idx_vector_indexes_doc_chunks",
            # Citation indexes
            "idx_citations_document_perf",
            "idx_citations_authors_search",
            "idx_citations_title_search",
            "idx_citations_year_desc",
            "idx_citations_doi_lookup",
            "idx_citations_type_filter",
            "idx_citations_confidence_desc",
            "idx_citations_created_desc",
            # Citation composite indexes
            "idx_citations_doc_confidence",
            "idx_citations_author_year",
            "idx_citations_type_confidence",
            # Citation relation indexes
            "idx_citation_relations_source_perf",
            "idx_citation_relations_target_perf",
            "idx_citation_relations_source_citation",
            "idx_citation_relations_target_citation",
            "idx_citation_relations_type_perf",
            "idx_citation_relations_confidence",
            "idx_citation_relations_source_target",
            "idx_citation_relations_type_confidence",
            # Tag indexes
            "idx_tags_name_unique",
            "idx_document_tags_document_perf",
            "idx_document_tags_tag_perf",
        ]
