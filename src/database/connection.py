...
class DatabaseConnection:
    ...
    @contextmanager
    def transaction(self, savepoint_name: Optional[str] = None) -> Iterator[sqlite3.Connection]:
        """
    ...
    def execute_many(self, query: str, params_list: List[Tuple[Any, ...]]) -> Optional[sqlite3.Cursor]:
        """
