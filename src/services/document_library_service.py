...
class DocumentLibraryService:
    ...
    def __init__(self, db_connection: DatabaseConnection, documents_dir: str = None):
        """
    ...
    def delete_document(self, document_id: int, remove_vector_index: bool = True) -> bool:
        """
                    ...
                    if vector_index:
                        ...
                        try:
                            ...
                            if index_path.exists():
                                ...
                                logger.debug(f"Removed vector index files: {index_path}")
                        except Exception as e:
    ...
    def get_library_statistics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            stats["health"] = {
                ...
                "index_coverage": vector_stats.get("coverage", {}).get("coverage_percentage", 0)
            }
        ...
        try:
            ...
            if document.file_path:
                ...
                if result["file_exists"]:
                    ...
                    # Verify file hash
                    try:
                        current_hash = ContentHashService.calculate_file_hash(document.file_path)
                        result["hash_matches"] = (current_hash == document.file_hash)
                        result["current_hash"] = current_hash
                        result["stored_hash"] = document.file_hash
                        
                        if not result["hash_matches"]:
                            result["errors"].append("File hash mismatch - file may have been modified")
    ...
    def advanced_search(self, **kwargs) -> List[DocumentModel]:
        """
