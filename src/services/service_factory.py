...
class DefaultServiceFactory(ServiceFactory):
    ...
    def create_service(self, service_type: Type[T], **kwargs: Any) -> T:
        ...
        try:
            ...
            logger.debug(f"Creating {service_type.__name__} with dependencies: {list(resolved_kwargs.keys())}")
    ...
    def _resolve_dependencies(self, service_type: Type, provided_kwargs: Dict[str, Any]) -> Dict[str, Any]:
        """
...
def get_service_factory() -> ServiceFactory:
    ...
    if _service_factory is None:
        raise RuntimeError("Service factory not initialized. Call initialize_service_factory() first.")
